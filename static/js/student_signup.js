...
if (signupForm) {
    signupForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (data.status === 'success') {
                showAlert(`✅ Account created! Your Student ID is: ${data.student_id} — Please note it down for login.`, 'success');
                setTimeout(() => { window.location.href = '/student_login'; }, 4000);
            } else {
    ...
    console.warn('Student signup form element not found');
}